...
// https://github.com/mattalberts/mustache/tree/mattalberts/conditional-implicit-iterator
replace github.com/cbroglie/mustache v1.4.0 => github.com/mattalberts/mustache v1.2.3-0.20210916194536-6ff633228b5b
